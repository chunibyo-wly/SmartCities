...
import argparse
import cv2
import model.pose.visualizations as vis
from model.pose.applications.model_wrapper import ModelWrapper
import model.pose.configs.draw_config as draw_config

model_path = "data/trained_models/model11_test-15Sun1219-2101"
...
class VideoApp:
    ...
    def process_frame(self, img):
        ...
        for skeleton in skeletons:
            skeleton.draw_skeleton(
                skeleton_drawer.joint_draw, skeleton_drawer.kpt_draw)
        return img
    ...
    def run(self, skip):
        ...
        while True:
            ...
            processed_img_bgr = cv2.cvtColor(
                processed_img_rgb, cv2.COLOR_RGB2BGR)
